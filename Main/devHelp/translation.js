...
const translationFilesPath = './public/locales/';

const watchPath = `${translationFilesPath}translation.en.json`;
...
const readMainTranslationFile = async (filePath) => {
        ...
        try {
            ...
            languages.forEach(async (lang) => {
                if (lang !== 'en') {
                    ...
                    fs.writeFile(`${translationFilesPath}translation.${lang}.json`, JSON.stringify(newTranslation, null, 2), 'utf-8', (err) => {
                        if (err) {
...
readMainTranslationFile(watchPath);