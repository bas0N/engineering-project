...
public class UserService {
    ...
    public ResponseEntity<?> login(HttpServletResponse response, LoginRequest loginRequest) {
        ...
        try {
            ...
            if (authenticate.isAuthenticated()) {
                String authToken = jwtService.generateToken(user.getUuid(), user.getEmail(), exp);
                String refreshToken = jwtService.generateToken(user.getUuid(), user.getEmail(), refreshExp);
